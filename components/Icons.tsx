...
export const SendIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="m22 2-11 11" /><path d="M22 2 15 22l-4-9-9-4 21-7Z" /></svg>
);

export const MicIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12 2a3 3 0 0 0-3 3v6a3 3 0 0 0 6 0V5a3 3 0 0 0-3-3Z" /><path d="M19 10v2a7 7 0 0 1-14 0v-2" /><line x1="12" x2="12" y1="19" y2="22" /></svg>
);
...
export const TikTokIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" {...props}><path d="M16 4h-2a4 4 0 0 0-4 4v10.5a2.5 2.5 0 1 0 5 0V11a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v4.5a2.5 2.5 0 1 0 5 0V8a4 4 0 0 0-4-4z"/></svg>
);
...
export const TwitterIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" {...props}><path d="M18.901 1.153h3.68l-8.04 9.19L24 22.846h-7.406l-5.8-7.584-6.638 7.584H.474l8.6-9.83L0 1.154h7.594l5.243 7.185L18.901 1.153ZM17.61 20.644h2.039L6.486 3.24H4.287l13.323 17.404Z"/></svg>
);

export const LinkedinIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" {...props}><path d="M16 8a6 6 0 0 0-12 0v7h4v-5a2 2 0 0 1 2-2 2 2 0 0 1 2 2v5h4z"/><rect x="4" y="9" width="4" height="12"/><circle cx="6" cy="4" r="2"/></svg>
);

export const WhatsappIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" {...props}><path d="M12.04 2c-5.46 0-9.91 4.45-9.91 9.91 0 1.75.46 3.42 1.29 4.89L2 22l5.29-1.38c1.4.78 2.99 1.21 4.67 1.21 5.46 0 9.91-4.45 9.91-9.91S17.5 2 12.04 2zM17.15 14.31c-.24-.13-1.47-.73-1.7-.82-.23-.09-.39-.13-.56.13-.17.25-.64.82-.78.98-.14.17-.29.18-.54.06s-1.06-.39-2.01-1.24c-.74-.66-1.24-1.48-1.38-1.73-.15-.25-.03-.38.12-.51.13-.13.29-.33.44-.5.15-.17.2-.23.3-.38.1-.15.05-.28-.03-.43-.08-.15-.74-1.78-.92-2.28-.17-.48-.34-.41-.47-.41h-.47c-.17 0-.43.06-.65.31-.22.25-.87.85-1.06 2.05-.2 1.21.23 2.61.71 3.59.48.98 1.41 2.38 3.52 3.48 2.11 1.09 2.83.92 3.65.59.82-.33.91-1.08.91-1.23 0-.15-.03-.28-.06-.36s-.17-.15-.42-.28z"/></svg>
);
